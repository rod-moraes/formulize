...
class FieldSwitchCustom extends StatefulWidget {
  final Question data;
  ...
  @override
  State<FieldSwitchCustom> createState() => _FieldSwitchCustomState();
}

class _FieldSwitchCustomState extends State<FieldSwitchCustom> {
